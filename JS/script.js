...
//Dicoding Kuis Functional Programming
...
const greatAuthors = books
    ...
    .map(book => `${book.author} adalah penulis buku ${book.title} yang sangat hebat!`); //ini mencetak buku yang salesnya > 1000000

const bookMap = books.map((book) => `${book.author} adalah penulis buku ${book.title} yang sangat hebat!`) //ini mencetak semua buku
